...
aws s3 sync $PWD/aws/  s3://brayan-bucket/aws/ --region us-east-1
aws cloudformation create-stack --stack-name CircleCiTest1 --template-url https://s3.amazonaws.com/brayan-bucket/aws/main.yml --capabilities CAPABILITY_IAM --region us-east-1
