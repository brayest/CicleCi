...
aws cloudformation create-stack --stack-name CircleCiTest --template-url https://s3.amazonaws.com/brayan-bucket/aws/main.yml --capabilities CAPABILITY_IAM --region us-east-1
